...
void BeliefManagerProcess::ownStart() {
  ...
  all_beliefs_publisher = n.advertise<aerostack_msgs::ListOfBeliefs>("all_beliefs", 1000);
...
bool BeliefManagerProcess::executeQuery(aerostack_msgs::QueryBelief::Request& req,
                                        aerostack_msgs::QueryBelief::Response& res) {
...
bool BeliefManagerProcess::removeBeliefs(aerostack_msgs::RemoveBelief::Request& req,
...
bool BeliefManagerProcess::checkBeliefFormat(aerostack_msgs::CheckBeliefFormat::Request& req,
                                         aerostack_msgs::CheckBeliefFormat::Response& res) {
...
bool BeliefManagerProcess::generateIDCallback(droneMsgsROS::GenerateID::Request& req,
...
bool BeliefManagerProcess::queryLastGeneratedIDCallback(droneMsgsROS::QueryLastGeneratedID::Request& req,
                                                      droneMsgsROS::QueryLastGeneratedID::Response& res) {
