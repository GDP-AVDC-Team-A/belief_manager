...
#include <droneMsgsROS/QueryLastGeneratedID.h>
 ...
 *         to use.
 *****************************************************************************/
class BeliefManagerProcess: public DroneProcess
{
public:
...
private:
  ...
  bool executeQuery(aerostack_msgs::QueryBelief::Request& req,
                    aerostack_msgs::QueryBelief::Response& res);
  bool addBeliefs(aerostack_msgs::AddBelief::Request& req,
                    aerostack_msgs::AddBelief::Response& res);
  bool removeBeliefs(aerostack_msgs::RemoveBelief::Request& req,
                    aerostack_msgs::RemoveBelief::Response& res);
  bool checkBeliefFormat(aerostack_msgs::CheckBeliefFormat::Request& req,
                         aerostack_msgs::CheckBeliefFormat::Response& res);

  void commonBeliefCallback(const droneMsgsROS::BeliefStatement& msg);

  bool generateIDCallback(droneMsgsROS::GenerateID::Request& req, droneMsgsROS::GenerateID::Response& res);

  bool queryLastGeneratedIDCallback(droneMsgsROS::QueryLastGeneratedID::Request& req, droneMsgsROS::QueryLastGeneratedID::Response& res);
